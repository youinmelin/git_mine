  ...
  <div class="about">
    ...
    <div class="main">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>{{ companyInfo.companyName }}</el-breadcrumb-item>
      </el-breadcrumb>
          ...
          <div class="peoson">
            <div class="item">
              ...
              <div class="right">
                ...
                <div class="rb">{{ companyInfo.name }}</div>
              </div>
            </div>
            <div class="item">
            ...
            <div class="item">
              ...
              <div class="right">
                <div class="rt">网址</div>
                <div class="rb"><a :href="companyInfo.siteUrl" target="_blank">{{ companyInfo.siteUrl }}</a></div>
              </div>
            </div>
            <div class="item">
              ...
              <div class="right">
                <div class="rt">地址</div>
                <div class="rb">{{ companyInfo.address }}</div>
              </div>
            </div>
          </div>
        </div>
